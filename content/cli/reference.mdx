...
- `--result-json [path]`: Write structured execution results to a JSON file (essential for CI and the VS Code extension). If no path is provided, writes to `glubean-run.result.json`.
