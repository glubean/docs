...
The vocabulary is worth pinning early: what the dashboard calls a **target** (an upload destination) _is_ a source when you compare implementations. See [Performance](/cloud/performance).
