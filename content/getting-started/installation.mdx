...
After Node is available, the extension becomes the main local entry point for writing and running verification checks.
...
That gives you both `glubean` and `gb` on PATH.
