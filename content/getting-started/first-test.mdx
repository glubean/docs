...
- Trace files and result files are described in [Reference: Artifacts](/reference/artifacts).
- For failure triage, continue with [Guides: Debugging](/guides/debugging).
