...
the shorter path is to hand one of these to your IDE agent:

<AskAgent
  prompts={[
    {
      intent: "First check",
      text: "Use the Glubean skill and add the first runnable API behavior check for «my API», run it, and show me the result.",
    },
    {
      intent: "From something I have",
      text: "Turn «this curl command / endpoint / OpenAPI operation» into a contract case with a response schema, and run it.",
    },
  ]}
/>
