...
Requires a `GLUBEAN_TOKEN` env var. See [Upload Your First Run](/cloud/quickstart) for setup.

## Next

- CI tuning patterns: [CLI Recipes](/cli/recipes)
- Environment switching strategy: [Guides: Environments](/guides/environments)
- Upload to Cloud: [Cloud Quickstart](/cloud/quickstart)
