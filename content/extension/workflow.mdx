...
Tests in `explore/` are meant for quick iteration. You click the gutter **▶ play button**, look at the trace file, adjust the code, and run it again. There are no consequences if an exploration test breaks.
