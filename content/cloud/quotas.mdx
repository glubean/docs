...
Glubean Cloud has a free tier that covers most individual and small team use cases. Paid plans add capacity, longer retention, and advanced features.
...
Need more runs without upgrading? Run packs add capacity to any plan:

- **2,000 additional runs** — $10 one-time purchase

Run packs don't expire until used. They apply after your monthly quota is exhausted.
...
- [Upload Your First Run](/cloud/quickstart) — get started
- [Roadmap](/cloud/roadmap) — upcoming features and limits changes
