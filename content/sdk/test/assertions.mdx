...
<AskAgent
  prompts={[
    {
      intent: "Pick the right tool",
      text: "Review «my checks» and pick the right tool per assertion — soft expect, .orFail(), assert, or validate — and explain each failure-behavior choice.",
    },
    {
      intent: "Schema-validate",
      text: "Add ctx.validate with a Zod schema for «this response» so shape drift fails the check with a structured diff.",
    },
  ]}
/>
