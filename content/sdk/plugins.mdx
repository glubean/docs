...
- [Browser (`@glubean/browser`)](/sdk/browser-plugin) — Playwright-powered browser automation
- [gRPC (`@glubean/grpc`)](/sdk/grpc-plugin) — Typed gRPC client with proto-first DX
