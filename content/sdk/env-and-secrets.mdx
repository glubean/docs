...
For env file naming, load order, system fallback, and `${...}` key mapping, see [Environments & Secrets](/guides/environments). This page focuses on SDK runtime access patterns.
